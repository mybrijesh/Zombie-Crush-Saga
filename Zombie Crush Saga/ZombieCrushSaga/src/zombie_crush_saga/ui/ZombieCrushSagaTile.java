...
//            updateWinPath(game);
    ...
    public boolean match(ZombieCrushSagaTile testTile)
    {
        ...
        //red
        else if(spriteType.getSpriteTypeID().equals("TILE_2") && testTile.getSpriteType().getSpriteTypeID().equals("TILE_13"))
            return true;
        //blue
        else if(spriteType.getSpriteTypeID().equals("TILE_1") && testTile.getSpriteType().getSpriteTypeID().equals("TILE_14"))
            return true;
        //green
        else if(spriteType.getSpriteTypeID().equals("TILE_0") && testTile.getSpriteType().getSpriteTypeID().equals("TILE_15"))
            return true;
        //yellow
        else if(spriteType.getSpriteTypeID().equals("TILE_3") && testTile.getSpriteType().getSpriteTypeID().equals("TILE_16"))
            return true;
        //orange
        else if(spriteType.getSpriteTypeID().equals("TILE_5") && testTile.getSpriteType().getSpriteTypeID().equals("TILE_17"))
            return true;
        //purple
        else if(spriteType.getSpriteTypeID().equals("TILE_4") && testTile.getSpriteType().getSpriteTypeID().equals("TILE_18"))
            return true;
        
        
       
        else if(spriteType.getSpriteTypeID().equals("TILE_13") && testTile.getSpriteType().getSpriteTypeID().equals("TILE_2"))
            return true;
        
        else if(spriteType.getSpriteTypeID().equals("TILE_14") && testTile.getSpriteType().getSpriteTypeID().equals("TILE_1"))
            return true;
        
        else if(spriteType.getSpriteTypeID().equals("TILE_15") && testTile.getSpriteType().getSpriteTypeID().equals("TILE_0"))
            return true;
        
        else if(spriteType.getSpriteTypeID().equals("TILE_16") && testTile.getSpriteType().getSpriteTypeID().equals("TILE_3"))
            return true;
        
        else if(spriteType.getSpriteTypeID().equals("TILE_17") && testTile.getSpriteType().getSpriteTypeID().equals("TILE_5"))
            return true;
        
        else if(spriteType.getSpriteTypeID().equals("TILE_18") && testTile.getSpriteType().getSpriteTypeID().equals("TILE_4"))
            return true;
