...
public class ZombieCrushSaga 
{
    ...
    public enum ZombieCrushSagaPropertyType
    {
        ...
        END_GAME_BUTTON_IMAGE_NAME,
        END_GAME_BUTTON_MOUSE_OVER_IMAGE_NAME,
        LEVEL_PROGRESS_BAR_IMAGE_NAME,
        IN_GAME_SCORE_BACKGROUND_IMAGE_NAME,
        IN_GAME_MOVE_BACKGROUND_IMAGE_NAME,
        ZOMBIE_SMASHER_IMAGE_NAME,
        ZOMBIE_SMASHER_MOUSE_OVER_IMAGE_NAME,
  ...
  //      LEVEL_MAP_COMPLETE_IMAGE_OPTIONS,
        ...
        TILE_ORANGE_TYPE,
        TILE_BOMB_TYPE,
        TILE_ORANGE_WRAPPED_TYPE,
        TILE_RED_WRAPPED_TYPE,
        TILE_BLUE_WRAPPED_TYPE,
        TILE_GREEN_WRAPPED_TYPE,
        TILE_YELLOW_WRAPPED_TYPE,
        TILE_PURPLE_WRAPPED_TYPE,
        TILE_TEST_TYPE,
