...
public class MahjongSolitaireLevelEditor
{
    ...
    private final int MIN_GRID_DIM = 5;
    private final int MAX_GRID_ROWS = 10;
    private final int MAX_GRID_COLUMNS = 20;
    private final int GRID_STEP = 1;
    //LEVEL 1 WILL HAVE 40 TILES 8 * 5
    //level 2 will have 73 tiles 9 * 9
    //level 3 will have 45 tiles 7 * 7
    //level 4 will have 69 tiles 9 * 9
    //level 5 will have 44 tiles 6 * 9
    //level 6 will have 45 tiles 5 * 9
    //level 7 will have 79 tiles 9 * 9
    //level 8 will have 73 tiles 9 * 9
    //level 9 will have 46 tiles 8 * 7
    //level 10 will have 78 tiles 9 * 9
    private final int TOTAL_TILES = 0;

    // TEXTUAL CONSTANTS
    private final String WINDOW_ICON_FILE_NAME = "../ZombieCrushSaga/img/zombiecrushsaga/BlueZombieSpecial.png";
    private final String APP_TITLE = "ZombieCrushSaga Level Editor";
    ...
    private final String ZOMBIECRUSHSAGA_DATA_DIR = "../ZombieCrushSaga/data/zombiecrushsaga/";
    ...
    public void initFileControls()
    {
        ...
        fileChooser = new JFileChooser(ZOMBIECRUSHSAGA_DATA_DIR);
    ...
    class GridClickHandler extends MouseAdapter
    {
        ...
        public void mousePressed(MouseEvent me)
        {
            ...
            {
//                this only allows user to add only one tile at column and row..
//                tiles can not be stacked on top of each other.
                if(value != 1)
                {
